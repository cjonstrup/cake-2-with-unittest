<?php
// make sure we start session before output is sent (php will interpret this as output already sent)
session_start();
...
if (!defined('WEBROOT_DIR')) {
    define('WEBROOT_DIR', basename(__DIR__ . DS . 'webroot'));
}

if (!defined('WWW_ROOT')) {
    define('WWW_ROOT', __DIR__ . DS . 'webroot' . DS);
}
